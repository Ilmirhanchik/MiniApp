...
function App() {
  ...
  return (
    <MaxUI>
      <div className="min-h-screen flex items-center justify-center py-12 bg-gray-50/70 backdrop-blur-sm">
      
        <div className="w-full max-w-lg bg-white shadow-2xl border border-gray-100 rounded-xl p-6 md:p-8 mx-auto">
